...
const MoviePage = () => {
  ...
  const search = async query => {
    await fetch(
      `https://api.themoviedb.org/3/search/movie?include_adult=true&query=${query}&api_key=76bdc971ba84bff496ab1d4f27cc9c5c`,
    )
  ...
  useEffect(() => {
    fetch('https://api.themoviedb.org/3/movie/popular?api_key=76bdc971ba84bff496ab1d4f27cc9c5c')
      .then(response => response.json())
      .then(result => setImages(result.results))
      .catch(error => console.log('error', error));
  }, []);
